...
CREATE TABLE "volunteers" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "phone" varchar(255), "email" varchar(255), "orientation" datetime, "status" varchar(255), "created_at" datetime, "updated_at" datetime);
